...
emissions_long_subset = emissions_long.query("country == ['Uganda', 'Kenya', 'Tanzania','Burundi', 'Brazil']")
...
emissions_long_subset["country_code"] = coco.convert(
    emissions_long_subset["country"], to="ISO3"
)
